...
Функция ЗафиксироватьПакет(Каталог, ДвоичныеДанные, Знач ИмяФайла, ОписаниеПакета, ЭтоТестоваяСборка) Экспорт
	...
	Пакет = ЗафиксироватьПакетВБД(ОписаниеПакета, ПутьККаталогуПакета, ИмяФайла, ЭтоТестоваяСборка);
...
Функция ЗафиксироватьПакетВБД(ОписаниеПакета, ПутьККаталогуПакета, ИмяФайла, ЭтоТестоваяСборка)
